...
SIGNAL \ALT_INV_pin_name~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\ALT_INV_pin_name~combout\ <= NOT \pin_name~combout\;
\ALT_INV_pin_name1~combout\ <= NOT \pin_name1~combout\;

\pin_name~I\ : stratixii_io
...
inst3 : stratixii_lcell_comb
-- Equation(s):
-- \inst3~combout\ = \pin_name~combout\ & \pin_name1~combout\
...
-- pragma translate_on
PORT MAP (
	datae => \ALT_INV_pin_name~combout\,
	dataf => \ALT_INV_pin_name1~combout\,
	combout => \inst3~combout\);

\pin_name2~I\ : stratixii_io
-- pragma translate_off
GENERIC MAP (
	ddio_mode => "none",
	ddioinclk_input => "negated_inclk",
